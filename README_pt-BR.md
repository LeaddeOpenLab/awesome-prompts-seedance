...
### Duelo cinematográfico de artes marciais orientais em floresta de bambu entre um mestre da espada de vestes carmesim e três assassinos de chapéu de palha.
...
**Resumo:** Duelo cinematográfico de artes marciais orientais em floresta de bambu entre um mestre da espada de vestes carmesim e três assassinos de chapéu de palha.
...
```text
Gere um curta-metragem de 30 segundos, 16:9, 24fps dedicado à coreografia de artes marciais orientais tradicionais ultrarrápida. Live-action fotorrealista teatral de alto orçamento + qualidade cinematográfica AAA. Sem legendas, sem interface de usuário, sem logotipos, sem narração, sem música de fundo (BGM)—mantenha apenas estalos de caules de bambu, farfalhar de folhas, estalos de tecido de seda, zunidos de lâminas, toques firmes dos pés em galhos esguios, deflexões metálicas, golpes pesados no tronco, whip pans e expirações bruscas.

Personagens

Protagonista: Assassino solitário em vestes carmesim, espada reta de dois gumes única (Jian), faixa de seda flexível, postura letal serena.

Assassinos (3 Assassinos de Chapéu de Palha): Vestes cinza-escuro idênticas, chapéus cônicos de bambu ocultando os olhos. Armas distintas: Assassino A (foice com corrente/Kusarigama), Assassino B (espadas-gancho duplas), Assassino C (bastão de ferro pesado).

Núcleo e Ação
Agilidade máxima, movimento desafiador da gravidade sobre a folhagem e ataques multidirecionais implacáveis. O primeiro quadro abre com todos os três assassinos caindo simultaneamente da copa alta de bambus. Apresenta passos leves escalando árvores, deslizamentos por caules de bambu curvados, redirecionamentos de armas no ar, giros com a faixa de seda e aparadas rápidas em combate corpo a corpo suspensos em galhos oscilantes.

Speed Ramp Único
Uma única microdesaceleração de 0,12 segundos na marca de 4 segundos: a foice com corrente do Assassino A se enrola em um caule de bambu a centímetros da garganta do protagonista, mostrando fragmentos de casca voando, tensão na corrente e o olhar frio do protagonista acompanhando a lâmina antes de cortar a corrente em pleno ar.

Câmera e Ambiente
Inclinações verticais de câmera vertiginosas, tomadas de rastreamento rápidas através de densos caules de bambu, lente grande-angular rastreando quedas descendentes, câmera tremendo com os impactos pesados do bastão. O ambiente reage violentamente: centenas de folhas verdes explodindo em rajadas de vento, caules de bambu quebrando sob a pressão dos pés, névoa espessa rodopiando em torno de mudanças bruscas de direção.

Sequência Final
O protagonista pisa no bastão estocado do Assassino C para ganhar elevação, executa um corte giratório invertido de 720° para baixo que corta as espadas-gancho de B e desarma A, em seguida cai diretamente atrás de C para um estocada reversa rápida na altura do pescoço. O quadro final captura as vestes carmesim assentando enquanto caules de bambu quebrados desabam ao redor do único vencedor.
```
...
```text
Crie uma sequência de batalha de fantasia sombria ultracinematográfica de 23 segundos, fotorrealista, estética de filme de fantasia de alto orçamento, widescreen 16:9.

CENA 1 — 0–3 segundos
Comece atrás de uma misteriosa guerreira de cabelos brancos em pé, sozinha diante de um enorme campo de batalha. Ela tem longos cabelos branco-prateados fluindo naturalmente ao vento, armadura medieval escura de couro e metal, e uma espada presa nas costas. À frente dela há um exército gigantesco cobrindo o campo de batalha. Torres medievais em ruínas e estruturas semelhantes a catedrais surgem ao longe. O sol está baixo no horizonte, criando uma poderosa contraluz dourada através de fumaça e poeira densas. Movimento lento e cinematográfico de aproximação da câmera (push-in) por trás dela, névoa atmosférica sutil, movimento de vento realista, escala épica.

```
...
### Instrução de geração de fluxo completo para cena cinematográfica de perseguição policial urbana em três planos, baseada em prévia no Blender e renderização no PixVerse.
...
**Resumo:** Instrução de geração de fluxo completo para cena cinematográfica de perseguição policial urbana em três planos, baseada em prévia no Blender e renderização no PixVerse.
...
```text
Crie uma perseguição de carros cinematográfica, original e fotorrealista utilizando um fluxo de trabalho estruturado de Blender para PixVerse. Projete dois carros, um motorista e um ambiente urbano. Crie três tomadas conectadas de 4 segundos com uma perseguição traseira, um acompanhamento lateral em curva e uma saída em plano aberto. Anime e valide no Blender o movimento dos veículos, a rotação das rodas, o esterçamento, a interação do motorista e as trajetórias da câmera. Renderize um vídeo em modelo cinza (gray-model) de 12 segundos em 1280×720. Use o PixVerse Plugin e o Seedance 2.5 para criar imagens de referência cinematográficas a partir dos primeiros quadros correspondentes, preservando composição, perspectiva e identidade dos veículos. Use essas referências com os vídeos do Blender para gerar cada tomada, mantendo o movimento de câmera original, as trajetórias, a temporização, as cores e as relações espaciais.
```
...
```text
Crie uma perseguição de carros original inspirada em GTA com acabamento cinematográfico live-action fotorrealista. Crie o motorista, dois carros e o ambiente urbano. Planeje três tomadas de 4 segundos: perseguição com rastreamento traseiro, rastreamento lateral em uma curva fechada e uma tomada aberta de saída. Construa a cena e a animação no Blender, incluindo veículos, rotação das rodas, direção, movimento do motorista e câmeras. Renderize o vídeo completo do modelo cinza de 12 segundos em 1280×720 e 24 fps. Em seguida, use o plugin PixVerse com Seedance 2.5 para transformar o primeiro quadro cinza de cada tomada em uma referência cinematográfica fotorrealista, preservando a composição, a perspectiva, as posições dos indivíduos e a contagem de veículos. Use cada referência cinematográfica junto com o vídeo correspondente do Blender para gerar as tomadas finais, mantendo a identidade dos veículos, as cores, o movimento da câmera, as trajetórias e o ritmo da ação.
```
...
Cinematográfico / Imagem de Filme · Cyberpunk / Ficção Científica · Personagem · Veículo · Publicado
...
### Prompt de vídeo plano a plano de 15 segundos de um jogador de futebol ajoelhado pedindo em casamento uma árbitra que lhe mostra um cartão vermelho.
...
**Resumo:** Prompt de vídeo plano a plano de 15 segundos de um jogador de futebol ajoelhado pedindo em casamento uma árbitra que lhe mostra um cartão vermelho.
...
```text
Crie um vídeo fotorrealista de 15 segundos em um estádio de futebol para o Seedance 2.5. Proporção de tela: paisagem 16:9. Filmagens autênticas de espectadores, movimento sutil de câmera na mão, luz natural do dia, pele realista, grama verde vívida e arquibancadas lotadas. Uma tomada contínua com zoom gradual.

Um jogador de futebol adulto do sexo masculino com cabelo curto e escuro veste um uniforme azul-marinho liso. Uma árbitra adulta com cabelo escuro preso em um coque firme veste um uniforme de árbitro todo preto e liso, meias pretas, relógio de pulso e apito. Todas as roupas e equipamentos não possuem marcas.

0–2 segundos: Visão panorâmica ampla da primeira fileira ao lado da linha lateral. Posicione o jogador de futebol à esquerda e a árbitra à direita, com o gramado e a torcida do estádio se estendendo atrás deles. As mãos e os celulares dos espectadores enquadram parcialmente os cantos inferiores. Ela segura um cartão vermelho liso para cima enquanto ele começa a se ajoelhar sobre um dos joelhos.

2–4 segundos: Dê um zoom lento em direção à dupla enquanto o joelho dele toca a grama. Ele levanta uma pequena caixinha de anel preta e a abre em direção a ela. Mantenha o cartão vermelho erguido, a caixinha aberta e ambos os personagens claramente visíveis dentro do enquadramento horizontal.

4–6 segundos: Estabilize em um plano médio conjunto (medium two-shot), mostrando o jogador ajoelhado em perfil três quartos e o rosto da árbitra com clareza. Ela nota o anel. Sua expressão severa se transforma em surpresa: as sobrancelhas se erguem, os lábios se entreabrem e o braço erguido fica momentaneamente congelado.

6–8 segundos: Aproxime-se ligeiramente mantendo ambos os rostos visíveis. Ela olha do anel para os olhos dele e abre um sorriso caloroso e emocionado. Ele permanece sobre um joelho, sorrindo e segurando a caixinha com firmeza.

8–10 segundos: Ela ri e abaixa lentamente o cartão vermelho para o lado do corpo. Seus ombros relaxam. Espectadores ao longo das bordas erguem seus celulares enquanto a empolgação da multidão cresce.

10–12 segundos: Ela assente alegremente com a cabeça e estende a mão livre em direção a ele. Ele fecha a caixinha do anel, segura-a com firmeza e se levanta naturalmente. Incline a câmera suavemente para cima para manter ambas as cabeças confortavelmente enquadradas.

12–15 segundos: Eles dão um passo um em direção ao outro e se abraçam calorosamente ao lado da linha lateral. Mantenha o casal centralizado, com companheiros de equipe se aproximando e aplaudindo ao fundo. Mantenha o abraço com uma oscilação sutil de câmera na mão.

Áudio: Ambiente natural do estádio, aplausos crescentes, vivas e risos felizes. Sem diálogos inteligíveis ou narração.

Restrições visuais: Rostos e roupas consistentes, mãos realistas, movimentos naturais e continuidade estável dos objetos. Composição em tela cheia 16:9, sem barras pretas. Sem texto, legendas, closed captions, logotipos, marcas d'água, nomes ou números na camisa, marcas de patrocinadores, placas legíveis, emojis ou sobreposições gráficas.
```
...
### Prompt de geração de vídeo multisegmento com realismo cinematográfico nas ruas de Manhattan nos anos 1990.
...
Fotografia · Cinematográfico / Imagem de Filme · Paisagem Urbana / Rua · Publicado

**Resumo:** Prompt de geração de vídeo multisegmento com realismo cinematográfico nas ruas de Manhattan nos anos 1990.
...
```text
{
  "format": "16:9, 30s, áudio nativo ativado, realismo cinematográfico, sem sobreposição de texto, sem legendas na tela",
  "style": "Cinematografia de rua de Manhattan dos anos 1990, emulação de película Kodak quente, granulação fina, névoa suave, reflexo de lente anamórfica",
  "subject_and_action": {
    "0-6s": "Plano aberto com câmera na mão avançando por uma calçada movimentada em Midtown Manhattan. Em primeiro plano, um homem de terno azul-marinho olha para o relógio de pulso enquanto caminha. Uma mulher de cabelos ruivos cacheados e blazer bege caminha ao lado dele. Vapor sobe de um carrinho de cachorro-quente com guarda-sóis listrados de azul e amarelo no centro do enquadramento. Táxis amarelos passam devagar pela rua.",
    "6-14s": "A câmera mantém um plano médio-aberto enquanto uma mulher com blusa de estampa floral vibrante troca um olhar e um sorriso com um homem de roupa bege e branca perto do carrinho de comida. Atrás deles, um homem de terno cinza e gravata bordô caminha em direção à câmera. A densidade da multidão permanece alta, todos em trajes profissionais, ritmo de caminhada natural e espaçado.",
    "14-20s": "Corte para um ângulo mais baixo e próximo na esquina de uma loja marcada como 'W 34th St.' Dois rapazes com roupas casuais streetwear (mochila, jeans, camisas polo) passam rindo na direção oposta, em primeiro plano, enquanto um táxi amarelo cruza velozmente a parte inferior do quadro em desfoque de movimento. Manequins de loja de roupas e uma placa de neon 'OPEN' visíveis na vitrine atrás deles.",
    "20-30s": "A câmera se estabiliza em um cruzamento com faixa de pedestres, ligeiramente elevada. Uma grande multidão de profissionais cruza a faixa com listras brancas em direção à câmera, táxis amarelos parados no trânsito ao lado, um segundo carrinho de cachorro-quente com guarda-sóis listrados à direita. A câmera permanece fixa enquanto a multidão diminui ligeiramente no final, puxando o foco em direção à linha do horizonte esfumaçada no fundo distante."
  },
  "environment": "Cruzamento denso em Midtown Manhattan, torres de escritórios altas sumindo na névoa atmosférica, carrinhos de vendedores ambulantes, faixas de pedestres pintadas, sinalização típica da época (mantida intencionalmente genérica/ilegível), clássicos táxis amarelos quadrados",
  "camera": "Câmera na mão em movimento de caminhada, nível dos olhos, dolly lento para frente com balanço natural; um corte seco aos 14s para um ângulo secundário; foco profundo em primeiro plano, suave desfoque nas torres ao fundo",
  "lighting_and_color": "Sol brilhante do meio-dia, luz principal âmbar quente, bordas de sombra suaves, fundo ligeiramente dessaturado com saturação marcante de amarelo/azul nos táxis e guarda-sóis",
  "audio": "Zumbido do tráfego urbano ambiente, murmúrio de multidão sobreposto e passos, buzinas distantes de carros, breve ronco de motor de ônibus no corte aos 14s, sem diálogos, sem música",
  "continuity": "Mesma densidade de multidão, mesmo modelo/cor de táxi, mesmo design de guarda-sol de carrinho de comida e mesma gradação de cores quentes mantida em todos os quatro segmentos",
  "constraints": "Nenhum texto legível em nenhuma placa, sem celulares ou veículos modernos, sem roupas anacrônicas, sem logotipos visíveis, sem rostos distorcidos ou duplicados"
}
```
...
### Um prompt para videoclipe cinematográfico de 30 segundos apresentando três cantores se apresentando em uma rua molhada da cidade iluminada por neon.
...
**Resumo:** Um prompt para videoclipe cinematográfico de 30 segundos apresentando três cantores se apresentando em uma rua molhada da cidade iluminada por neon.
...
```text
Crie um videoclipe cinematográfico ultrarrealista de 30 segundos com três cantores jovens adultos apresentando uma música moderna e emocionante em uma cidade iluminada por neon à noite. O vídeo deve se parecer com um videoclipe profissional de alto orçamento, com humanos realistas, sincronia labial precisa, performances expressivas, iluminação atmosférica e cinematografia sofisticada.

PERSONAGENS

NEGATIVO: metamorfose de rosto, mudanças de identidade, roupas inconsistentes, pessoas extras, personagens duplicados, mãos distorcidas, rostos deformados, caminhar não natural, movimentos robóticos, sincronia labial incorreta, conversas aleatórias, cintilação, artefatos de interpolação de quadros, texto, legendas, logotipos, marcas d'água.
```
...
### Instruções de produção para uma perseguição de carros no estilo GTA, detalhando desde a criação do modelo 3D em cinza no Blender até a finalização em vídeo com o PixVerse \(Seedance 2.5\).
...
**Resumo:** Instruções de produção para uma perseguição de carros no estilo GTA, detalhando desde a criação do modelo 3D em cinza no Blender até a finalização em vídeo com o PixVerse \(Seedance 2.5\).
...
```text
Siga este fluxo de trabalho de produção para criar uma perseguição de carros 3D original no estilo GTA:

[Design]
Desenvolva 1 motorista principal, 1 carro de fuga, 1 carro perseguidor e 1 cenário urbano com visuais consistentes. Planeje 3 planos de 4 segundos cada:
- Um plano de perseguição acompanhando os veículos por trás
- Um plano lateral acompanhando os veículos fazendo uma curva fechada
- Um plano aberto capturando os veículos acelerando para longe

[Construção no Blender]
Crie modelos cinzas limpos e rigs funcionais para os personagens e veículos. Texturas e mapeamento UV não são necessários.

[Animação e testes]
Anime o motorista, o volante, a rotação das rodas, os veículos e as câmeras. Mantenha a direção do trajeto e a ordem dos carros consistentes; corrija interpenetrações, rodas flutuando, derrapagens irreais dos pneus, poses corrompidas e mãos que se soltam do volante.

[Renderização no Blender]
Renderize os quadros de 1 a 288 em 1280×720 a 24 fps. Junte os quadros efetivamente renderizados no Blender em um vídeo mestre de modelo cinza de 12 segundos. Exporte cada plano separadamente e renderize imagens estáticas cinzas correspondentes como referências de forma e enquadramento.

[Finalização com o plugin PixVerse]
Use o Seedance 2.5 em 720p para processar cada plano individualmente. Utilize o vídeo do Blender como referência de movimento e as imagens estáticas cinzas para manter a consistência das formas. Especifique um esquema de cores uniforme nos prompts de geração para todas as filmagens. Mantenha os movimentos de câmera, o ritmo da ação, o design de personagens e veículos e a quantidade de carros.

[Revisão e entrega]
Revise ambos os vídeos finalizados quanto a artefatos visuais e à continuidade entre os planos. Corrija problemas subjacentes no Blender e gere novamente apenas os planos que falharem no Seedance, limitando as novas tentativas a 2 por plano.

Entregue o arquivo .blend editável, o vídeo nativo em 720p do modelo cinza do Blender, o vídeo em 720p rotulado como versão Seedance e uma breve avaliação das limitações restantes.
```
...
Quadrinhos / Storyboard · Fotografia · Renderização 3D · Publicado
...
### Prompt de storyboard para comercial de luxo de perfume botânico de 15 segundos, apresentando gotas de orvalho em macro, close-up do produto, monólogo do personagem e encerramento da marca.

Autor：[@yourPlugAI](https://x.com/yourPlugAI) · [Publicação original](https://x.com/yourPlugAI/status/2098306219903492133)

Quadrinhos / Storyboard · Marketing de Produto · Personagem · Produto · Publicado
...
**Resumo:** Prompt de storyboard para comercial de luxo de perfume botânico de 15 segundos, apresentando gotas de orvalho em macro, close-up do produto, monólogo do personagem e encerramento da marca.
...
Visual: Tomada em plano de detalhe extremo (extreme macro) com inclinação para cima (tilt-up) através de folhas tropicais verdes e vibrantes pingando gotas de orvalho matinal. A luz do sol brilha intensamente contra a lente (lens flare), iluminando o pólen flutuante e as partículas de água.
Ação: Gotas de orvalho deslizam por uma grande folha de palmeira e espirram sobre uma pedra bruta em câmera lenta hiper-realista, lançando instantaneamente microgotas para cima.
Som: Harmonia profunda de sopros de madeira orgânicos abrindo para um efeito sonoro de respingo nítido e hiperdetalhado, acompanhado por um suave canto de pássaros e farfalhar de folhas.

3 a 6 Segundos (A Revelação do Produto)
Visual: Órbita suave da câmera ao redor de um frasco de perfume de vidro fosco, posicionado em pé sobre uma rocha de basalto coberta de musgo, cercada por orquídeas selvagens desabrochando.
Ação: Uma névoa botânica fina, semelhante ao orvalho, é borrifada com precisão pelo bico lateral, dispersando-se horizontalmente enquanto a luz nítida do sol captura cada microgota, criando um efeito sutil de prisma de arco-íris.
Som: Clique metálico limpo da bomba de spray seguido por um som atmosférico e refrescante de dispersão de névoa e o zumbido suave de uma brisa.

6 a 9 Segundos (O Diálogo do Personagem)
Visual: Plano médio da mulher em pé em uma estufa botânica banhada pelo sol, afastando suavemente uma folha de samambaia verde do rosto e olhando diretamente para a lente da câmera com um olhar sereno e confiante.
Ação: Ela inclina ligeiramente a cabeça em direção à luz solar, com o rosto relaxado e perfeitamente estável, recitando sua fala naturalmente com um sorriso suave.
Som: Acorde suave e terroso de cordas acústicas sob uma locução calorosa e sussurrada: "Breathe the wild."

9 a 12 Segundos (A Onda Sensorial)
Visual: Sequência acelerada (fast-forward) de desabrochar onde pétalas de flores douradas se abrem ao redor do frasco de perfume, fundindo-se perfeitamente com a luz solar em espiral e folhas verdes sob uma física de movimento dinâmica.
Ação: Musgo terroso e pétalas de flores sobem suavemente no ar ao redor do frasco, criando um efeito de flutuação natural e sem peso.
Som: Crescimento de uma melodia acústica inspiradora combinado com uma transição suave de ar em movimento (swoosh) e texturas delicadas de farfalhar.

12 a 15 Segundos (O Encerramento da Marca)
Visual: Plano de destaque centralizado (hero shot) do frasco de vidro fosco, em pé sobre uma placa de mármore iluminada pelo sol em meio a musgo verde fresco e orvalho matinal. A marca gravada "GILBERTO" se destaca em uma tipografia dourada nítida.
Ação: A luz da manhã varre suavemente o frasco da esquerda para a direita enquanto uma delicada névoa botânica se assenta na base.
Som: Carrilhão acústico caloroso e encorpado que se prolonga em um suave fadeout.
```
...
### Crie um vlog realista de 30 segundos sobre o estilo de vida em um rancho americano, acompanhando a rotina diária de uma rancheira do nascer ao pôr do sol.
...
**Resumo:** Crie um vlog realista de 30 segundos sobre o estilo de vida em um rancho americano, acompanhando a rotina diária de uma rancheira do nascer ao pôr do sol.
...
```text
Crie um vlog ultrafotorrealista de 30 segundos sobre o estilo de vida em um rancho americano, acompanhando a mesma jovem fazendeira ao longo de um autêntico dia de trabalho, do nascer ao pôr do sol. Comece com ela abrindo o estábulo e alimentando os cavalos, depois consertando uma cerca de madeira antes de selar um cavalo e cavalgar por campos abertos do Oeste.

Mostre um rancho funcional genuíno, com celeiros desgastados pelo tempo, piquetes para cavalos, feno, caminhos de terra, cercas de madeira, caminhonetes, campos verdes e colinas ao longe. Mantenha a personagem, o cavalo, as roupas e o ambiente do rancho perfeitamente consistentes.

Capture o comportamento realista dos cavalos, a biomecânica da cavalgada, o impacto dos cascos, a poeira, o movimento da grama, os arreios de couro, a ração, a madeira, as batidas de martelo e a luz solar natural. Utilize uma cinematografia de vlog documental de 2026 com câmera na mão, incluindo close-ups, planos gerais do rancho, foco automático realista, tremores sutis de câmera e uma cavalgada suave durante a hora de ouro.

Apenas áudio diegético natural: cavalos, pássaros, vento, sons do celeiro, passos de cascos, ferramentas, couro e insetos. Diálogos curtos e sincronizados em inglês americano. Sem música, narração, legendas, CGI, movimento artificial, física impossível, logotipos ou marcas d'água.
```
...
### Prompt de vídeo com estilo de gravação natural de smartphone retratando uma mulher de yukata comprando takoyaki e passeando em um festival de outono.
...
**Resumo:** Prompt de vídeo com estilo de gravação natural de smartphone retratando uma mulher de yukata comprando takoyaki e passeando em um festival de outono.
...
```text
Japão moderno, noite no caminho de acesso a um santuário que lembra um festival de outono de meados de setembro em Fukuoka. Uma jovem japonesa usando um lindo yukata é filmada espontaneamente por uma amiga com um smartphone. A iluminação acolhedora das barracas contrasta com o ar noturno levemente azulado do início do outono.

A jovem encontra uma barraca e compra takoyaki. Após receber o pedido, segura a bandeja em formato de barco na altura do peito, pega apenas um takoyaki com um palito e, por estar quente, sopra brevemente em frente à boca para esfriar antes de comer com naturalidade. Ela não exagera na reação ao sabor; apenas o olhar e os lábios se suavizam levemente. Preocupada com o molho ou os flocos de bonito, dá leves toques na boca com um lenço de papel.

Logo em seguida ela começa a caminhar, mudando de cenário e enquadramento em um ritmo ágil a cada 2 ou 3 segundos: a fileira de barracas, a multidão, o caminho mais largo e uma área um pouco mais calma ao lado do santuário. A câmera não fica muito tempo apenas nas costas dela, alternando naturalmente entre perfil, detalhes das mãos, ângulo diagonal traseiro e planos mais abertos da caminhada. No final, as luzes das barracas vão se distanciando, e a brisa da noite balança sua franja e as mangas do yukata. Por fim, enquanto caminha, a câmera se move para o lado, fechando em um plano detalhe natural do rosto. O vídeo termina deixando a nostalgia do festival e o clima da transição do fim do verão para o início do outono.

Sem falas, sem legendas, sem trilha sonora, sem logotipos. Sem atuações exageradas, sem poses de modelo, sem olhar para a câmera. Não manter a câmera fixa por muito tempo. Não morder diretamente da bandeja; o takoyaki deve ser comido sempre com palito. Manter a continuidade do rosto da personagem, yukata, obi, penteado, leque uchiwa e bandeja.
```
