...
### Storyboard prompt for a cinematic stunt shot of a race car jumping through an overturning train carriage and drifting to safety.

Author：[@TanLuAI](https://x.com/TanLuAI) · [Source](https://x.com/TanLuAI/status/2098353311808385384)

Comic / Storyboard · Cinematic / Film Still · Vehicle · Published

Source：[@TanLuAI](https://x.com/TanLuAI) · [Source](https://x.com/TanLuAI/status/2098041885856272478)

**Summary:** Storyboard prompt for a cinematic stunt shot of a race car jumping through an overturning train carriage and drifting to safety.
...
```text
[Generation Requirements] Generate a 10-second, 16:9 widescreen, live-action cinematic car stunt video. The visuals must possess intense impact, tight pacing, and clear physical feedback. A white-and-red supercar charges at high speed toward an overturned teal train carriage, leans sideways off an incline ramp, crashes in through a large side window, traverses across the carriage interior, and shatters the opposite glass window to burst out. The moment the car lands, the train carriage slams violently down behind it; the car enters a continuous drift and successfully escapes danger. Except for a newly added 2-second slow-motion shot of breaking through the window, all other shots maintain high speed. The car continually moves forward, with no stopping, prepping to launch, or repositioning. [Asset Anchors and Reference Rules] Reference video Sept 9: Camera work, trajectory, spatial relationships, and pacing reference. The low-slung geometric vehicle with white and red stripes corresponds to the race car in Image 1; the teal horizontal rectangular prism corresponds to the train carriage in Image 2; the tilted geometric plate corresponds to the metal ramp. The yellow window frame only marks the traversal position and must ultimately be replaced with a realistic silver metallic window frame. Use only 8 seconds from the reference video; insert a 2-second close-up side-angle slow-motion shot at the moment the car is about to smash through the exit glass, with subsequent shots delayed accordingly, totaling 10 seconds for the final video. Retain the camera positions, shot scales, vehicle path, carriage overturn direction, and movement speed of the corresponding segments. On this basis, add realistic suspension, tires, shattering, collision, and environmental feedback. The newly added slow motion seamlessly connects to the same window-exit action without repeating the impact. Image 1: Car appearance. Low-profile, wide-body supercar in white, with red longitudinal racing stripes and red side accents, black tinted cockpit glass, slender headlights, dark wheel rims, red brake calipers, and a carbon-fiber lower body kit. Vehicle model, proportions, and livery remain consistent throughout the film. Minor fine scratches are permitted after smashing through the window, while the bodywork remains intact. Image 2: Carriage appearance. Deep teal modern urban train carriage with silver metallic window frames, large side windows, light-colored interior, seats, handrails, ceiling light strips, and bottom bogies. The interior is empty of people, with the central large windows on both sides directly facing each other, keeping the horizontal pass-through zone clear. The studio background from the reference image must not appear in the video. [Visual Style] Realistic car stunt cinematography, real-world proportions, natural lighting, delicate car paint, and weighty mechanical texture. Bright overcast day after rain, with sunlight breaking through clouds to illuminate flying glass shards and water droplets; the city is overall cool gray, making the white-and-red car and teal carriage stand out vividly. Enhance the motion depth across foreground, midground, and background: nearby debris and guardrails whip past at high speed, the car in the midground remains sharp, and distant buildings establish a stable spatial reference. Normal-speed shots use natural directional motion blur; in slow motion, glass facets, water droplets, and vehicle reflections are distinctly discernible. Impact is conveyed through body deformation, suspension strain, debris directionality, road surface feedback, and brief camera shakes. The camera consistently tracks key actions, quickly stabilizing after impact tremors. [Scene] A closed elevated highway in a modern Tokyo urban district, adjacent to elevated train tracks. Dark gray asphalt is covered with a thin film of water after rain, with scattered shallow puddles reflecting vehicles and sky. The ground features worn lane markings, drainage grates, expansion joints, and fine gravel. Concrete barriers, metal sound barriers, streetlights, and curved reflective markers are sequentially arranged along both sides, providing high-speed parallax. The wide left-hand curve ahead remains clear, visibly revealing the car's turn entry, tail slide, and grip recovery line. Steel girders, bridge piers, railway ties, and metal components of the adjacent track are visible. The carriage overturns horizontally toward the road, exposing bottom mechanical structures, with partially loosened parts vibrating with inertia. Interior light strips, handrails, and window frames rotate with the carriage body, enhancing spatial dynamics. Densely packed residential towers, glass office buildings, and rooftop equipment extend layer upon layer into the distance, with a light perspective haze in the post-rain air. Background architecture does not obstruct the car, window openings, or escape route. No pedestrians are on the road or inside the carriage. [Shot Content, Camera Movement, and Sound Effects] [00:00—00:01.21] Shot 1: Colossal Object Overturns, Car Intrudes. Low-angle shot facing forward. The opening shows only the teal carriage flipping sideways toward the road and the camera, its body horizontally blocking the path ahead. As it rolls, the lower steel chassis and bogies are exposed, window reflections rapidly shift, loose metal components rattle, and a few old glass fragments and accumulated water fling off the carriage body. The white-and-red race car then storms in at high speed from behind the camera, swiftly dominating the foreground; its tires slice through the surface water film, throwing out two low plumes of water spray behind it. The camera cuts to a tracking follow-shot as the massive carriage rapidly approaches ahead of the car. Sound effects: Heavy metal twisting, continuous structural groaning and vibrations, the roar of the engine sweeping in violently from far to near, accompanied by tire water dispersion and air pressure noise. [00:01.21—00:02.29] Shot 2: Launching off the Ramp, Skimming the Window Frame. Low-angle rear-quarter high-speed tracking shot. The car's right-side wheels hit the metal ramp in rapid succession; the ramp instantly vibrates under pressure, bouncing up small amounts of gravel and water droplets from its edges. The right suspension compresses first, then rebounds as the wheels leave the ramp, raising the right side of the chassis, tilting the entire car to the left, and becoming briefly airborne. The front of the car aligns precisely with the rotating side window. The clearance between the window frame edge and the car roof rapidly narrows, tires still spinning at high speed, with the undercarriage shadow swiftly sweeping across the asphalt, demonstrating unmistakable forward inertia. Sound effects: Two rapid, heavy clanks on the ramp, chassis vibration, high-revving engine scream, and a sudden surge of wind resistance. [00:02.29—00:03.29] Shot 3: Shattering the Entry, Piercing the Confined Space. The camera closely follows the car as its nose slams into the large entry window. Glass at the contact point fractures abruptly, then explodes inward into the carriage interior, generating a stream of debris dispersing along the car's forward path. The car bursts through the opening, glass granules peppering seats and handrails, with a few shards whipping past the edges of the frame. Bright outdoor ambient light instantly cuts to brief interior carriage lighting, while overhead light strips and vertical poles blur past at high speed, heightening the sensation of speed inside the confined space. The opposite exit window remains intact, with the road outside clearly visible. The car's front closes in rapidly, cutting just before contacting the exit glass. Sound effects: Sharp shattering blast, dense metallic clatter of shards striking metal and interior fixtures, and a brief, echoing engine roar inside the carriage. [00:03.29—00:05.29] Shot 4: Side Close-up, Glass Exploding Outward from the Frame. Cut to an oblique side-angle close-up outside the exit window, keeping the teal carriage exterior, silver window frame, and the approaching white-and-red car in frame. Enters 2 seconds of high-speed slow motion, seamlessly continuing the same window-exit action. The front of the car strikes the glass; dense fracture lines spread instantly across adjacent panes. Immediately, the glass is shoved outward by the car's nose, bursting into a swarm of fine particles and clusters of partially intact fragments, fanning out layer by layer along the forward momentum. **The glass possesses three clear layers of depth:** a few foreground shards streak past the camera lens; midground shards surround the nose and front wheels, flashing cool white glints as they tumble; background glass continues peeling away from the frame edges. Gaps between fragments keep the white-and-red chassis continuously visible. The front bumper, front wheels, cockpit, doors, and rear wheels emerge in sequence. The camera tracks horizontally over a short distance alongside the body, as the red livery glides through sparkling fragments. Water droplets are flung off the car's surface, glass granules graze the paint, the window frame visibly buckles, and a brief burst of sparks flares at the abrasion point. The carriage continues to roll while the car keeps thrusting outward. The rear wheels fully clear the frame, glass shards still expanding behind, before returning to normal speed. Sound effects: Fine, crisp cracking of glass, elongated explosive shatter, fluttering debris sounds, and a deep engine rumble; wind noise rapidly snaps back to regular speed at the end. [00:05.29—00:06.50] Shot 5: Hard Landing, Carriage Slams Down with a Crash. Cut to a low-angle shot in front and to the side of the car. The car levels out, tires pounding the road in sequence; the suspension noticeably compresses, the body dips and quickly rebounds. Tires press out flat sheets of spray, the undercarriage briefly skims close to the wet asphalt, and the vehicle continues lunging forward. Immediately after, the side of the train carriage behind crashes onto the road. The contact edge deforms first under localized crushing before the heavy mass slams down as a whole, buckling the outer shell with dents, rattling window frames, and dislodging remaining glass in clusters. The impact kicks up a low mist of water, fine gravel, and concrete dust across the road. The carriage slides a short distance along the pavement, dragging bright sparks along the friction line as loose components rattle down. The heavy impact imparts a brief camera jolt, while the car cleanly tears away from the foreground, with debris and water mist behind it generating a visual sensation of trailing pressure. Sound effects: Heavy thud of tires landing, followed by the low-frequency thunder of the carriage slamming the deck, buckling sheet metal, sustained grinding, and a rain of glass. [00:06.50—00:09.25] Shot 6: Ground-Hugging Drift, Arc of Water Spray. Low front-quarter tracking shot as the car cuts directly into a left-hand curve. Front wheels steer into the turn while the rear swings outward, the chassis leaning slightly under lateral load as the tires cling firmly to the wet asphalt. The rear tires kick up two curving plumes of fine water mist tracing the arc of the turn, the outer plume wider, with fine droplets pulled into long trails by the wake. Reflections on the wet road shift rapidly with the car's rotation; the red stripes, black rims, and white bodywork remain crisp throughout the sustained slide. The camera hugs the ground, with foreground lane lines, drainage grates, and barrier bases streaking backward at breakneck speed, while the car remains locked in frame, emphasizing the speed contrast between subject and background. In the latter half of the drift, the rear tucks back in, tires regain full traction, the suspension levels out, and the car accelerates smoothly out of the slide. Sound effects: Intense tire friction and water channeling sounds, engine RPM modulation, fine gravel ticking against the undercarriage, with the crash sounds behind fading rapidly into the distance. [00:09.25—00:10.00] Shot 7: Gripping and Accelerating Away, Clean Finish. Rear-quarter tracking shot. The car straightens out on the roadway, all four wheels planted firmly with solid grip, rocketing forward at high speed. The white-and-red body, black rear diffuser, and taillights are clearly visible as the trailing mist thins out and streetlights and guardrails race backward. Concludes on the action of the car completing its escape and roaring off into the distance, with no static showcase stop. Sound effects: Sustained engine acceleration, tire roar on asphalt, and rushing high-speed wind. [Prohibitions] No repeated window-exits or rewinding back into the carriage; no premature self-shattering glass, backwards-flying debris, or paper-like soft fragments; no debris completely concealing the car. No prolonged slow motion outside the specified shot; no stopping, reversing, revving up from a standstill, or hovering in midair; no driving down the carriage's longitudinal corridor; no clipping through unbroken solid structures. No generating massive dry white smoke during wet drifts; no toy-like bouncing of the carriage, unprompted road collapse, giant fireballs, or explosive shockwaves; no masking motion with continuous heavy camera shake. No asset morphing, duplication, teleportation, wheel count alterations, or livery shifting; no pedestrians, passengers, or unrelated vehicles; no untextured white models, guide boxes, cartoon styles, or video game graphics. No subtitles, watermarks, voiceovers, dialogue, background music, or BGM; only synchronous on-set diegetic sound effects.
```
...
### Detailed multi-shot cinematic music video prompt featuring three singers in a neon-lit city street at night.

Author：[@meAsifAi](https://x.com/meAsifAi) · [Source](https://x.com/meAsifAi/status/2098330707374514573)

Cinematic / Film Still · Cityscape / Street · Published

**Summary:** Detailed multi-shot cinematic music video prompt featuring three singers in a neon-lit city street at night.
